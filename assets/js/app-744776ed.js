...
if (typeof window !== "undefined") {
  let loadSvg = function() {
    ...
    svgDom.innerHTML = '<symbol fill="none"  viewBox="0 0 12 12" id="arrow-down"><path d="M9.75 4.5 6 8.25 2.25 4.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" /></symbol><symbol fill="none"  viewBox="0 0 36 36" id="back"><circle cx="18" cy="18" r="17.5" stroke="currentColor" /><path d="M20.428 14.571h-2.285v-2.285h2.285v2.285ZM22.713 12.286h-2.285V10h2.285v2.286ZM18.143 16.857h-2.286v-2.285h2.286v2.285ZM15.857 19.143h-2.286v-2.286h2.286v2.286ZM18.143 21.428h-2.286v-2.286h2.286v2.286ZM20.428 23.714h-2.285V21.43h2.285v2.285ZM22.713 26h-2.285v-2.286h2.285V26Z" fill="#1A1A1A" /></symbol><symbol fill="none"  viewBox="0 0 18 20" id="clip"><path d="M17.75 5.625c0 1.336-.52 2.591-1.465 3.536L7.28 18.274a3.744 3.744 0 0 1-2.656 1.098c-.96 0-1.92-.365-2.65-1.096a3.755 3.755 0 0 1 0-5.303l6.506-6.47c.977-.97 2.53-1.002 3.463-.07.455.456.695 1.07.676 1.733a2.544 2.544 0 0 1-.752 1.726L5.69 16.067a.624.624 0 1 1-.883-.884l6.174-6.174c.24-.24.377-.552.386-.88a1.088 1.088 0 0 0-.31-.812c-.447-.445-1.208-.413-1.697.073l-6.506 6.468a2.503 2.503 0 0 0 .001 3.534c.975.975 2.561.975 3.536 0l9.006-9.113A3.727 3.727 0 0 0 16.5 5.625c0-1.002-.39-1.943-1.098-2.651a3.725 3.725 0 0 0-2.652-1.099c-1.002 0-1.944.39-2.652 1.099l-8.783 8.72a.624.624 0 1 1-.88-.888l8.78-8.718A4.964 4.964 0 0 1 12.75.625c1.335 0 2.59.52 3.535 1.465a4.965 4.965 0 0 1 1.465 3.535Z" fill="#141414" /></symbol><symbol fill="none"  viewBox="0 0 80 80" id="play"><circle cx="40" cy="40" r="40" fill="#E6FE51" /><path d="M37.286 31.429H43v-5.715h-5.714v5.715ZM31.57 25.714h5.715V20h-5.714v5.714ZM42.997 37.143h5.714V31.43h-5.714v5.714ZM48.715 42.857h5.715v-5.714h-5.715v5.714ZM42.997 48.571h5.714v-5.714h-5.714v5.714Z" fill="#1A1A1A" /><path d="M37.286 54.286H43V48.57h-5.714v5.715ZM31.57 60h5.715v-5.714h-5.714V60Z" fill="#1A1A1A" /></symbol><symbol fill="none"  viewBox="0 0 20 20" id="plus"><circle cx="10" cy="10" r="9.5" stroke="currentColor" /><path d="M9.566 13V7h.868v6h-.868ZM7 10.425V9.59h6v.835H7Z" fill="#595959" /></symbol><symbol fill="none"  viewBox="0 0 32 20" id="quote"><path d="M30.527.184V4.83c-2.255-.104-3.794.129-4.617.696-.796.568-1.194 1.703-1.194 3.406 2.468-.026 4.299.4 5.493 1.277C31.403 11.06 32 12.44 32 14.35c0 1.987-.584 3.432-1.751 4.335-1.141.877-2.892 1.316-5.254 1.316-2.574 0-4.458-.529-5.652-1.587-1.194-1.058-1.79-2.8-1.79-5.225 0-2.735.304-5.031.915-6.889.637-1.883 1.552-3.29 2.746-4.218a9.088 9.088 0 0 1 4.06-1.858c1.512-.284 3.263-.297 5.253-.039ZM12.975.223v4.644c-2.255-.103-3.794.13-4.617.697-.796.568-1.194 1.703-1.194 3.406 2.468-.026 4.299.4 5.493 1.277 1.194.851 1.79 2.232 1.79 4.141 0 1.987-.583 3.419-1.75 4.296C11.556 19.561 9.803 20 7.443 20c-2.574 0-4.458-.516-5.652-1.548C.597 17.394 0 15.652 0 13.227c0-2.735.305-5.031.915-6.889.637-1.884 1.553-3.29 2.747-4.219A9.087 9.087 0 0 1 7.722.262c1.512-.284 3.263-.297 5.253-.039Z" fill="#D9EA4C" /></symbol><symbol fill="none"  viewBox="0 0 18 18" id="toolbox"><path d="M9 17A8 8 0 1 0 9 1a8 8 0 0 0 0 16Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" /><path d="M9 14.334a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" fill="#D8D8D8" /><path d="M9 10.333v-.666a2.333 2.333 0 1 0-2.334-2.334" stroke="#D8D8D8" stroke-linecap="round" stroke-linejoin="round" /></symbol>';
...
var _config = {
...
}, _isArray$1 = Array.isArray, _strictNumExp = /(?:-?\.?\d|\.)+/gi, _numExp = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, _numWithUnitExp = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, _complexStringNumExp = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, _relExp = /[+-]=-?[.\d]+/, _delimitedValueExp = /[^,'"\[\]\s]+/gi, _unitExp = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, _globalTimeline, _win$5, _coreInitted$4, _doc$5, _globals = {}, _installScope = {}, _coreReady, _install = function _install2(scope) {
  ...
  var parent2 = vars.parent || _globalTimeline, func = vars.keyframes ? _setKeyframeDefaults(_isArray$1(vars.keyframes)) : _setDefaults$1;
...
}, _slice$1 = [].slice, _isArrayLike = function _isArrayLike2(value, nonEmpty) {
  return value && _isObject$1(value) && "length" in value && (!nonEmpty && !value.length || value.length - 1 in value && _isObject$1(value[0])) && !value.nodeType && value !== _win$5;
  ...
  return _context$2 && !scope && _context$2.selector ? _context$2.selector(value) : _isString$1(value) && !leaveStrings && (_coreInitted$4 || !_wake()) ? _slice$1.call((scope || _doc$5).querySelectorAll(value), 0) : _isArray$1(value) ? _flatten(value, leaveStrings) : _isArrayLike(value) ? _slice$1.call(value, 0) : value ? [value] : [];
...
var Animation = /* @__PURE__ */ function() {
  ...
  _proto.timeScale = function timeScale(value) {
    ...
    this.totalTime(_clamp$2(-this._delay, this._tDur, tTime), true);
    _setEnd(this);
...
var Timeline = /* @__PURE__ */ function(_Animation) {
  ...
  _proto2.totalDuration = function totalDuration(value) {
    var max = 0, self = this, child = self._last, prevStart = _bigNum$1, prev2, start, parent2;
    if (arguments.length) {
...
_forEachName("staggerTo,staggerFrom,staggerFromTo", function(name) {
  Tween[name] = function() {
    var tl2 = new Timeline(), params = _slice$1.call(arguments, 0);
...
var _media = [], _listeners$1 = {}, _emptyArray$1 = [], _lastMediaTime = 0, _dispatch$1 = function _dispatch(type) {
  ...
  if (time - _lastMediaTime > 2) {
    ...
    _media.forEach(function(c) {
      ...
      for (p in queries) {
        match = _win$5.matchMedia(queries[p]).matches;
        match && (anyMatch = 1);
...
var _gsap = {
  ...
  registerEffect: function registerEffect(_ref3) {
    ...
    _effects[name] = function(targets, vars, tl2) {
      return effect(toArray(targets), _setDefaults$1(vars || {}, defaults3), tl2);
    };
    if (extendTimeline) {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var _win$4, _doc$4, _docElement, _pluginInitted, _tempDiv, _recentSetterPlugin, _reverting, _windowExists$2 = function _windowExists2() {
  return typeof window !== "undefined";
  ...
  if (_windowExists$2() && window.document) {
    ...
    _docElement = _doc$4.documentElement;
...
document.addEventListener("click", (e) => {
  if (e.target.closest(".js-start-video")) {
    e.target.closest(".js-start-video").querySelector(".video__play");
    const video2 = e.target.closest(".js-start-video").querySelector(".video__src");
...
document.addEventListener("click", (e) => {
  ...
  if (e.target.closest(".js-open-spoiler")) {
    (_a = e.target.closest(".work__item")) == null ? void 0 : _a.classList.toggle("work__item--opened");
  }
});
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var gsap$2, _coreInitted$3, _win$3, _doc$3, _docEl$2, _body$2, _isTouch, _pointerType, ScrollTrigger$2, _root$1, _normalizer$1, _eventTypes, _getGSAP$2 = function _getGSAP() {
  ...
  sc: _scrollCacheFunc(function(value) {
    return arguments.length ? _win$3.scrollTo(value, _vertical.sc()) : _win$3.pageXOffset || _doc$3[_scrollLeft] || _docEl$2[_scrollLeft] || _body$2[_scrollLeft] || 0;
  })
}, _vertical = {
  s: _scrollTop,
  p: "top",
  ...
  op: _horizontal,
  sc: _scrollCacheFunc(function(value) {
    return arguments.length ? _win$3.scrollTo(_horizontal.sc(), value) : _win$3.pageYOffset || _doc$3[_scrollTop] || _docEl$2[_scrollTop] || _body$2[_scrollTop] || 0;
  })
  ...
  _scrollers[i + offset2] || element.addEventListener("scroll", _onScroll$1);
  ...
  func.target = element;
  prev2 || (func.smooth = gsap$2.getProperty(element, "scrollBehavior") === "smooth");
  return func;
  ...
  if (gsap$2 && typeof document !== "undefined" && document.body) {
    ...
    _body$2 = _doc$3.body;
    _root$1 = [_win$3, _doc$3, _docEl$2, _body$2];
    gsap$2.utils.clamp;
...
var Observer = /* @__PURE__ */ function() {
  ...
  _proto.init = function init4(vars) {
    _coreInitted$3 || _initCore$1(gsap$2) || console.warn("Please gsap.registerPlugin(Observer)");
    ...
    lineHeight || (lineHeight = parseFloat(_win$3.getComputedStyle(_body$2).lineHeight) || 22);
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var gsap$1, _coreInitted$2, _win$2, _doc$2, _docEl$1, _body$1, _root, _resizeDelay, _toArray$2, _clamp$1, _time2, _syncInterval, _refreshing, _pointerIsDown, _transformProp, _i, _prevWidth, _prevHeight, _autoRefresh, _sort, _suppressOverwrites, _ignoreResize, _normalizer, _ignoreMobileResize, _baseScreenHeight, _baseScreenWidth, _fixIOSBug, _context$1, _scrollRestoration, _limitCallbacks, _startup = 1, _getTime = Date.now, _time1 = _getTime(), _lastScrollTime = 0, _enabled = 0, _pointerDownHandler = function _pointerDownHandler2() {
  ...
  return (s = "scroll" + d2) && (a = _getProxyProp(element, s)) ? a() - _getBoundsFunc(element)()[d] : _isViewport2(element) ? (_docEl$1[s] || _body$1[s]) - (_win$2["inner" + d2] || _docEl$1["client" + d2] || _body$1["client" + d2]) : element[s] - element["offset" + d2];
...
}, _abs = Math.abs, _left = "left", _top = "top", _right = "right", _bottom = "bottom", _width = "width", _height = "height", _Right = "Right", _Left = "Left", _Top = "Top", _Bottom = "Bottom", _padding = "padding", _margin = "margin", _Width = "Width", _Height = "Height", _px = "px", _getComputedStyle$1 = function _getComputedStyle(element) {
  ...
  var tween = withoutTransforms && _getComputedStyle$1(element)[_transformProp] !== "matrix(1, 0, 0, 1, 0, 0)" && gsap$1.to(element, {
    x: 0,
    y: 0,
    xPercent: 0,
    yPercent: 0,
  ...
  _isString2(scrollRestoration) && (_win$2.history.scrollRestoration = _scrollRestoration = scrollRestoration);
  ...
  if (state2) {
    ...
    (state2.t._gsap || gsap$1.core.getCache(state2.t)).uncache = 1;
    for (; i < l; i += 2) {
      value = state2[i + 1];
      p = state2[i];
      if (value) {
  ...
  left: 0,
  top: 0
}, _parsePosition2 = function _parsePosition3(value, trigger2, scrollerSize, direction, scroll, marker, markerScroller, self, scrollerBounds, borderWidth, useFixedPosition, scrollerMax, containerAnimation) {
  ...
  if (!_isNumber2(value)) {
    ...
    element = _getTarget(trigger2) || _body$1;
...
var ScrollTrigger$1 = /* @__PURE__ */ function() {
  function ScrollTrigger2(vars, animation) {
    _coreInitted$2 || ScrollTrigger2.register(gsap$1) || console.warn("Please gsap.registerPlugin(ScrollTrigger)");
  ...
  _proto.init = function init4(vars, animation) {
    ...
    if (snap3) {
      ...
      _scrollers.forEach(function(o) {
        return _isFunction2(o) && o.target === (isViewport ? _doc$2.scrollingElement || _docEl$1 : scroller) && (o.smooth = false);
      });
      ...
      if (r !== self.isReverted) {
        ...
        if (pin) {
          if (r) {
            ...
            (!pinReparent || !self.isActive) && _swapPinIn(pin, spacer, _getComputedStyle$1(pin), spacerState);
          }
        }
        r || self.update(r);
    ...
    self.refresh = function(soft, force) {
      ...
      start = _parsePosition2(parsedStart, trigger2, size, direction, scrollFunc(), markerStart, markerStartTrigger, self, scrollerBounds, borderWidth, useFixedPosition, max, containerAnimation) || (pin ? -1e-3 : 0);
      ...
      if (_isString2(parsedEnd) && !parsedEnd.indexOf("+=")) {
        if (~parsedEnd.indexOf(" ")) {
          ...
          parsedEnd = _isString2(parsedStart) ? parsedStart : start + offset3;
          parsedEndTrigger = trigger2;
        }
      }
      end = Math.max(start, _parsePosition2(parsedEnd || (parsedEndTrigger ? "100% 0" : max), parsedEndTrigger, size, direction, scrollFunc() + offset3, markerEnd, markerEndTrigger, self, scrollerBounds, borderWidth, useFixedPosition, max, containerAnimation)) || -1e-3;
      ...
      while (i--) {
        ...
        if (curPin && curTrigger.start - curTrigger._pinPush <= start && !containerAnimation && curTrigger.end > 0) {
          ...
          if ((curPin === trigger2 && curTrigger.start - curTrigger._pinPush < start || curPin === pinnedContainer) && !_isNumber2(parsedStart)) {
    ...
    self.update = function(reset, recordVelocity, forceFake) {
      ...
      if (clipped !== prevProgress2 && self.enabled) {
        ...
        toggleClass2 && (toggled || once && clipped && (clipped < 1 || !_limitCallbacks)) && _toArray$2(toggleClass2.targets).forEach(function(el) {
    ...
    self.enable = function(reset, refresh) {
      if (!self.enabled) {
        ...
        _addListener2(isViewport ? _doc$2 : scroller, "scroll", _onScroll2);
  ...
  ScrollTrigger2.disable = function disable(reset, kill) {
    ...
    _removeListener2(_doc$2, "touchcancel", _passThrough2);
  ...
  ScrollTrigger2.enable = function enable() {
    ...
    _body$1 = _doc$2.body;
    if (gsap$1) {
      _toArray$2 = gsap$1.utils.toArray;
      ...
      if (_body$1) {
        ...
        _root = [_win$2, _doc$2, _docEl$1, _body$1];
        ...
        _addListener2(_doc$2, "touchcancel", _passThrough2);
  ...
  ScrollTrigger2.scrollerProxy = function scrollerProxy(target, vars) {
    ...
    if (vars) {
      isViewport ? _proxies.unshift(_win$2, vars, _body$1, vars, _docEl$1, vars) : _proxies.unshift(t, vars);
    }
  };
  ...
  ScrollTrigger2.isInViewport = function isInViewport(element, ratio, horizontal) {
    ...
    return horizontal ? bounds.right - offset2 > 0 && bounds.left + offset2 < _win$2.innerWidth : bounds.bottom - offset2 > 0 && bounds.top + offset2 < _win$2.innerHeight;
  };
  ScrollTrigger2.positionInViewport = function positionInViewport(element, referencePoint, horizontal) {
    ...
    return horizontal ? (bounds.left + offset2) / _win$2.innerWidth : (bounds.top + offset2) / _win$2.innerHeight;
  };
...
var _clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier2(scrollFunc, current, end, max) {
  ...
  if (!cache._isScrollT || time - cache._isScrollT > 2e3) {
    ...
    cache._isScroll = node && !_isViewport2(node) && node !== target && (_overflow[(cs = _getComputedStyle$1(node)).overflowY] || _overflow[cs.overflowX]);
  ...
  var _vars2 = vars, normalizeScrollX = _vars2.normalizeScrollX, momentum = _vars2.momentum, allowNestedScroll = _vars2.allowNestedScroll, self, maxY, target = _getTarget(vars.target) || _docEl$1, smoother2 = gsap$1.core.globals().ScrollSmoother, smootherInstance = smoother2 && smoother2.get(), content = _fixIOSBug && (vars.content && _getTarget(vars.content) || smootherInstance && vars.content !== false && !smootherInstance.smooth() && smootherInstance.content()), scrollFuncY = _getScrollFunc(target, _vertical), scrollFuncX = _getScrollFunc(target, _horizontal), scale = 1, initialScale = (Observer.isTouch && _win$2.visualViewport ? _win$2.visualViewport.scale * _win$2.visualViewport.width : _win$2.outerWidth) / _win$2.innerWidth, wheelRefresh = 0, resolveMomentumDuration = _isFunction2(momentum) ? function() {
  ...
  vars.onEnable = function() {
    ...
    _addListener2(_win$2, "resize", onResize2);
  ...
  vars.onDisable = function() {
    ...
    _removeListener2(_win$2, "resize", onResize2);
...
mm.add(breakpoints.isDesktop, () => {
  const panels = gsapWithCSS.utils.toArray(".js-stack-container");
  panels.pop();
  panels.forEach((panel, i) => {
    ...
    tl2.fromTo(panel, { y: 0, rotate: 0, scale: 1, opacity: 1 }, { y: panel.offsetHeight / 100 * 25, scale: 0.9 }, 0).to(panel, 0.1, {
      opacity: 1
    });
  });
});
  ...
  gsapWithCSS.registerEffect({
    ...
    effect: (targets, config3) => {
      return gsapWithCSS.to(targets, {
        delay: 0.5,
        width: currentItem == null ? void 0 : currentItem.offsetWidth
      });
    }
  });
  gsapWithCSS.effects.setWidth(".case-category__line");
  tabTrigger.forEach((elem) => {
    elem.addEventListener("click", (e) => {
      if (elem.classList.contains("case-category__item--current"))
        return;
      tabTrigger.forEach((trigger2) => {
        trigger2.classList.remove("case-category__item--current");
      });
      elem.classList.add("case-category__item--current");
      const currentItem2 = document.querySelector(".case-category__item--current");
      ...
      gsapWithCSS.to(".case-category__line", {
        x: currentItem2.getBoundingClientRect().left + document.querySelector(".case-category").scrollLeft - parseInt(gap),
        width: currentItem2 ? currentItem2.offsetWidth : null
      });
      tab.forEach((el) => {
...
let isOpen$1 = false;
document.addEventListener("click", (e) => {
  if (!e.target.closest(".js-toolbox") && isOpen$1) {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var gsap, _coreInitted$1, _win$1, _doc$1, _docEl, _body, _toArray$1, _clamp2, ScrollTrigger, _mainInstance, _expo, _getVelocityProp2, _inputObserver2, _context, _onResizeDelayedCall, _windowExists4 = function _windowExists5() {
  return typeof window !== "undefined";
  ...
  var parent2 = el.parentNode || _docEl, b1 = el.getBoundingClientRect(), b2 = parent2.getBoundingClientRect(), gapTop = b2.top - b1.top, gapBottom = b2.bottom - b1.bottom, change = (Math.abs(gapTop) > Math.abs(gapBottom) ? gapTop : gapBottom) / (1 - progress), offset2 = -change * progress, ratio, extraChange;
  if (change > 0) {
    ratio = b2.height / (_win$1.innerHeight + b2.height);
  ...
  var wrapper = _doc$1.querySelector(".ScrollSmoother-wrapper");
  if (!wrapper) {
    wrapper = _doc$1.createElement("div");
...
var ScrollSmoother = /* @__PURE__ */ function() {
  function ScrollSmoother2(vars) {
    ...
    var _vars = vars, smoothTouch = _vars.smoothTouch, _onUpdate = _vars.onUpdate, onStop = _vars.onStop, smooth = _vars.smooth, onFocusIn = _vars.onFocusIn, normalizeScroll = _vars.normalizeScroll, content, wrapper, height, mainST, effects, sections, intervalID, wrapperCSS, contentCSS, paused, pausedNormalizer, recordedRefreshScroll, recordedRefreshScrub, self = this, resizeObserver = typeof ResizeObserver !== "undefined" && vars.autoResize !== false && new ResizeObserver(function() {
      ...
      if (effects) {
        effects.forEach(function(st) {
          var start = st.start, end = st.auto ? Math.min(ScrollTrigger.maxScroll(st.scroller), st.end) : start + (st.end - start) / st.ratio, offset2 = (end - st.end) / 2;
          start -= offset2;
          end -= offset2;
    ...
    }, effectValueGetter = function effectValueGetter2(name, value, index2, el) {
      return function() {
        var v = typeof value === "function" ? value(index2, el) : value;
        v || v === 0 || (v = el.getAttribute("data-" + effectsPrefix + name) || (name === "speed" ? 1 : 0));
        el.setAttribute("data-" + effectsPrefix + name, v);
        return v === "auto" ? v : parseFloat(v);
      };
    }, createEffect = function createEffect2(el, speed, lag, index2) {
      var getSpeed = effectValueGetter("speed", speed, index2, el), getLag = effectValueGetter("lag", lag, index2, el), startY = gsap.getProperty(el, "y"), cache = el._gsap, ratio, st, autoSpeed, scrub, progressOffset, yOffset, initDynamicValues = function initDynamicValues2() {
        speed = getSpeed();
        lag = getLag();
        ...
        initDynamicValues();
      }, pins = [], markers = [], change = 0, updateChange = function updateChange2(self2) {
        if (autoSpeed) {
          revert();
          ...
          change = (self2.end - self2.start) * (1 - ratio);
          yOffset = 0;
        }
        pins.forEach(function(p) {
    ...
    this.scrollTo = function(target, smooth2, position) {
      var p = gsap.utils.clamp(0, ScrollTrigger.maxScroll(_win$1), isNaN(target) ? _this.offset(target, position) : +target);
    ...
    function refreshHeight() {
      ...
      return height - _win$1.innerHeight;
    }
    ...
    this.effects = function(targets, config3) {
      ...
      config3 = config3 || {};
      var _config2 = config3, speed = _config2.speed, lag = _config2.lag, effectsToAdd = [], i, st;
      for (i = 0; i < targets.length; i++) {
    ...
    ScrollTrigger.scrollerProxy(wrapper, {
      ...
      getBoundingClientRect: function getBoundingClientRect() {
        return {
          top: 0,
          left: 0,
          width: _win$1.innerWidth,
          height: _win$1.innerHeight
        };
      }
    });
    ...
    var existingScrollTriggers = ScrollTrigger.getAll().filter(function(st) {
      return st.scroller === _win$1 || st.scroller === wrapper;
    });
    ...
    mainST = ScrollTrigger.create({
      ...
      onRefresh: function onRefresh2(self2) {
        ...
        self2.setPositions(self2.start, refreshHeight());
        recordedRefreshScrub || killScrub(self2);
        scroll.y = -scrollFunc();
        render3(scroll.y);
        startupPhase || self2.animation.progress(gsap.utils.clamp(0, 1, recordedRefreshScroll / -self2.end));
    ...
    this.kill = this.revert = function() {
      ...
      var defaults3 = ScrollTrigger.defaults({});
      defaults3 && defaults3.scroller === wrapper && ScrollTrigger.defaults({
        scroller: _win$1
      });
      ...
      _win$1.removeEventListener("focusin", _onFocusIn);
    };
    ...
    "overscrollBehavior" in _win$1.getComputedStyle(_body) && gsap.set([_body, _docEl], {
      overscrollBehavior: "none"
    });
    "scrollBehavior" in _win$1.getComputedStyle(_body) && gsap.set([_body, _docEl], {
      scrollBehavior: "auto"
    });
    _win$1.addEventListener("focusin", _onFocusIn);
    intervalID = setInterval(updateVelocity, 250);
    _doc$1.readyState === "loading" || requestAnimationFrame(function() {
...
const showHeader = gsapWithCSS.fromTo(
  header,
  {
    position: "fixed",
    opacity: 0
...
gsapWithCSS.to(header, { duration: 0.1, y: 0 });
...
let isOpen = false;
const tl$1 = gsapWithCSS.timeline({ paused: true });
const openModal = tl$1.fromTo(
  modalWrapper,
  {
    display: "none",
    opacity: 0
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var _doc, _win, _coreInitted, _stripExp = /(?:\r|\n|\t\t)/g, _multipleSpacesExp = /(?:\s\s+)/g, _initCore3 = function _initCore4() {
  _doc = document;
  _win = window;
  _coreInitted = 1;
...
}, _findSpecialChars = function _findSpecialChars2(text2, chars) {
  ...
  var children2 = _toArray(e.childNodes), l = children2.length, i, child;
  for (i = 0; i < l; i++) {
    child = children2[i];
    if (child._isSplit) {
      _deWordify2(child);
  ...
  if (lines || absolute) {
    for (i = 0; i < l; i++) {
      ...
      if (isChild || absolute || chars && !words) {
        ...
        if (lines && isChild && Math.abs(offset2 - lineOffsetY) > lineThreshold && (node.nodeName !== "BR" || i === 0)) {
          curLine = [];
          lines.push(curLine);
          lineOffsetY = offset2;
        }
  ...
  for (i = 0; i < l; i++) {
    ...
    if (!words && chars) {
      if (node._isSplit) {
        ...
        offset2 && node.parentNode.appendChild(_doc.createTextNode(" "));
        if (tag === "span") {
  ...
  for (i = 0; i < l; i++) {
    ...
    if (specialChars && (testResult = specialChars(text2.substr(i), vars.specialChars))) {
      character = text2.substr(i, testResult || 1);
      splitText += chars && character !== " " ? charStart() + character + "</" + tag + ">" : character;
      i += testResult - 1;
    } else if (character === wordDelimiter && text2.charAt(i - 1) !== wordDelimiter && i) {
      splitText += wordIsOpen ? wordEnd : "";
      wordIsOpen = 0;
      while (text2.charAt(i + 1) === wordDelimiter) {
        splitText += space;
        i++;
      }
      if (i === l - 1) {
    ...
    } else if (character === "{" && text2.substr(i, 6) === "{{LT}}") {
      splitText += chars ? charStart() + "{{LT}}</" + tag + ">" : "{{LT}}";
      i += 5;
    } else if (character.charCodeAt(0) >= 55296 && character.charCodeAt(0) <= 56319 || text2.charCodeAt(i + 1) >= 65024 && text2.charCodeAt(i + 1) <= 65039) {
      j = ((text2.substr(i, 12).split(emojiExp) || [])[1] || "").length || 2;
      splitText += chars && character !== " " ? charStart() + text2.substr(i, j) + "</" + tag + ">" : text2.substr(i, j);
      i += j - 1;
    } else {
      splitText += chars && character !== " " ? charStart() + character + "</" + tag + ">" : character;
    }
  ...
  var children2 = _toArray(element.childNodes), l = children2.length, absolute = _isAbsolute(vars), i, child;
  if (element.nodeType !== 3 || l > 1) {
    ...
    for (i = 0; i < l; i++) {
      ...
      if (child.nodeType !== 3 || /\S+/.test(child.nodeValue)) {
        if (absolute && child.nodeType !== 3 && _getComputedStyle2(child).display === "inline") {
...
window.addEventListener("load", () => {
  titles.forEach((title) => {
    ...
    new SplitText(title, { type: "lines", linesClass: "line" });
    gsapWithCSS.fromTo(
      split.lines,
      {
        y: 200
...
const caseAnim = (target) => gsapWithCSS.timeline().fromTo(
  target,
  {
    opacity: 0
  },
